...
//#define ELF_USE_GLASS_BED
#define ELF_BMG // Enable if the extruder runs the wrong way
//#define ELF_BLTOUCH // Enable if you want to use BLTOUCH
...
#define STRING_CONFIG_H_AUTHOR "(jbot, Creativity Elf)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.72,  21.72 }
    #define DEFAULT_Ki_LIST {   1.68,   1.68 }
    #define DEFAULT_Kd_LIST {  70.10,  70.10 }
  #else
    // Creativity Elf, autotuned with S220
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #if ENABLED(ELF_USE_GLASS_BED)
    // Creativity Elf with Glass Bed
    // @TODO: Not tuned yet
    #define DEFAULT_bedKp 164.94
    #define DEFAULT_bedKi  32.14
    #define DEFAULT_bedKd 564.19
  #else
    // Creativity Elf with Magnetic Bed
    #define DEFAULT_bedKp 164.94
    #define DEFAULT_bedKi  32.14
    #define DEFAULT_bedKd 564.19
  #endif
...
#define LEVEL_BED_CORNERS
   ...
   */
  #define LEVEL_CORNERS_LEVELING_ORDER { RB, RF, LF, LB }
#endif
